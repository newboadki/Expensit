...
extension MonthlySummaryTests {
    ...
    func test_monthly_breakdown_all_categories() async throws {
        ...
        Test.assertSectionsEventually([Test.SectionInfo(expectedEntries: [Test.Expense(title: "JAN", value: "$4,684.10"),
                                                        ...
                                                        sectionIndex: 1,
                                                        sectionName: "2013"),
                                       Test.SectionInfo(expectedEntries: [Test.Expense(title: "JAN", value: ""),
    ...
    func test_monthly_breakdown_food() async throws {
        ...
        Test.assertSectionsEventually([Test.SectionInfo(expectedEntries: [Test.Expense(title: "JAN", value: "-$45.00"),
                                                                          Test.Expense(title: "FEB", value: ""),
                                                                          Test.Expense(title: "MAR", value: ""),
                                                                          Test.Expense(title: "APR", value: ""),
                                                                          Test.Expense(title: "MAY", value: ""),
    ...
    func test_monthly_breakdown_bills() async throws {
        ...
        Test.assertSectionsEventually([Test.SectionInfo(expectedEntries: [Test.Expense(title: "JAN", value: ""),
    ...
    func test_monthly_breakdown_travel() async throws {
        ...
        Test.assertSectionsEventually([Test.SectionInfo(expectedEntries: [Test.Expense(title: "JAN", value: "-$320.90"),
                                                                          Test.Expense(title: "FEB", value: ""),
                                                                          Test.Expense(title: "MAR", value: ""),
                                                                          Test.Expense(title: "APR", value: ""),
                                                                          Test.Expense(title: "MAY", value: ""),
    ...
    func test_monthly_breakdown_incoming() async throws {
        ...
        Test.assertSectionsEventually([Test.SectionInfo(expectedEntries: [Test.Expense(title: "JAN", value: "$5,050.00"),
                                                                          Test.Expense(title: "FEB", value: ""),
                                                                          Test.Expense(title: "MAR", value: ""),
                                                                          Test.Expense(title: "APR", value: ""),
                                                                          Test.Expense(title: "MAY", value: ""),
