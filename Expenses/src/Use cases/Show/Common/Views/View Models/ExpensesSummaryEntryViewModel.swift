...
struct ExpensesSummaryEntryViewModel : Identifiable
{
    ...
    init(id: DateIdentifier, title : String?, value : String?, signOfAmount : BSNumberSignType, date: String?, tag: String?, tagId: Int = 2, dateTime: Date = Date())
    {
        self.id = id
        self.title = title
        self.value = value
