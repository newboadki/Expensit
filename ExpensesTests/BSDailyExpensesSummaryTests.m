...
@property (strong, nonatomic) BSPerMonthExpensesSummaryViewController *dailyViewController;
@end
...
- (void)setUp
{
    ...
    self.dailyViewController = [[BSPerMonthExpensesSummaryViewController alloc] init];
